...
#echo "########################################-----------------"
#./condor_run_je.sh w ${RunDir} ${INPUT} ex_histograms_wprime.txt ${OUTPUT} . 
echo "./local_run.sh w ${RunDir} ${INPUT} histo_wprime.txt ${OUTPUT} . "
./local_run.sh w ${RunDir} ${INPUT} histo_wprime.txt ${OUTPUT} . 
